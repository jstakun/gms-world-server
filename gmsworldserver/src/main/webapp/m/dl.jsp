...
<body>
 <div class="wrap">
    ...
    <div class="content">
    	...
    	You'll need to accept some permissions in the application in order to get some commands working on your device. In order to execute remotely command on Device Locator you need to send following SMS message: 
