 ...
 <div class="wrap">
    ...
    <div class="content">
    	...
    	<ul>
    	   ...
    	   <li><b>Lockdl</b> -  lock device screen. Requires enabled lock screen permission.<br/>Usage: Lockdl&lt;security pin&gt;<br/>Example (assuming your security pin is 1234): <b>Lockdl1234</b><br/></li>
