...
<body>
 <div class="wrap">
    ...
    <div class="content">
    	...
    	In order to execute remotely command on Device Locator you need to send following SMS message: 
    	
    	<p><b>&lt;command&gt;&lt;security pin&gt; &lt;optional parameters&gt;</b></p>
    	
    	<b>Security PIN</b> is generated by Device Locator during application installation and you can find it and change it on SMS control card. <br/><br/>
    	...
    	<ul>
           ...
           <li><b>Resumedl</b> - resume or start device location tracking and location recoding<br/>Usage: Resumedl&lt;security pin&gt;.<br/>Example (assuming your security pin is 1234): <b>Resumedl1234</b><br/></li>
