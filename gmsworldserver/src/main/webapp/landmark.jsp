                        ...
                        <!--div id="map_canvas" style="width:512px; height:256px"></div-->
                          ...
                          <p class="image-section">
                              <a href="/showLandmark/<%=key%>/fullScreen">
                                  <img src="<%= ImageUtils.getImageUrl(landmark.getLatitude(), landmark.getLongitude(), "640x256", 12, true, ConfigurationManager.MAP_PROVIDER.OSM_MAPS, request.isSecure()) %>" alt="Landmark on the Map" title="See landmark on the map" width="640" height="256"/>
                              </a>
                          </p> 
