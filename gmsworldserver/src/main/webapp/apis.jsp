<%-- 
    Document   : apis
    Created on : 2012-02-14, 08:32:06
    Author     : jstakun
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <head>
        <title>We are APIs company</title>
            ...
            <div id="content">
                ...
                <div id="main">
                    ...
                    <p>
                        <b>Social</b>
                        <ul>
                            <li><a href="http://developers.facebook.com/docs/reference/api/">Facebook Graph</a></li>
                            <li><a href="http://developer.foursquare.com/">Foursquare</a></li>
                    ...
                    <p>
                        <b>Location</b>
                        <ul>
                            <li><a href="http://www.skyhookwireless.com/location-technology/">Skyhook</a></li>
                        </ul>
                    </p>
                    <p>
                        <b>Personalization</b>
                    ...
                    <p>
                        <b>APIs Java Wrappers</b><br/>
                        <ul>
                            <li><a href="http://restfb.com/">Facebook</a></li>
                            <li><a href="http://code.google.com/p/foursquare-api-java/">Foursquare</a></li>
                            <li><a href="http://code.google.com/p/linkedin-j/">LinkedIn</a></li>
                            <li><a href="http://twitter4j.org/en/index.html">Twitter</a></li>
                            <li><a href="http://flickrj.sourceforge.net/">Flickr</a></li>
                        </ul>
                    </p>
                    <br/>
                    <!-- /main -->
