 ...
 * @author jstakun
 */
public class TwSendUpdateServlet extends HttpServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(TwSendUpdateServlet.class.getName());
    /** 
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logger.log(Level.SEVERE, "Oops !!! Somebody called " + TwSendUpdateServlet.class.getName());
	...
	/*protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
			...
			if (token == null || secret == null) {
                ...
                OAuthToken oauth_token = OAuthTokenPersistenceUtils.selectOAuthTokenByService(username, password, Commons.TWITTER);
                if (oauth_token != null) {
