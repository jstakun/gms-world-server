 ...
 * @author jstakun
 */
public class GooglePlacesProviderServlet extends HttpServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(GooglePlacesProviderServlet.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (HttpUtils.isEmptyAny(request,"latitude","longitude","radius")) {
                ...
                int radius = NumberUtils.getRadius(request.getParameter("radius"), 1, 50);
                ...
                String resp = LayerHelperFactory.getGooglePlacesUtils().processRequest(latitude, longitude, null, radius * 1000, version, limit, stringLimit, language, null).toString();
                out.println(resp);
            }
        } catch (Exception e) {
