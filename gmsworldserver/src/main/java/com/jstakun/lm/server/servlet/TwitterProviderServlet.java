 ...
 * @author jstakun
 */
public class TwitterProviderServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (HttpUtils.isEmptyAny(request, "lat", "lng", "radius")) {
                ...
                out.println(LayerHelperFactory.getTwitterUtils().processRequest(latitude, longitude, null, radius, version, limit, stringLimit, null, null).toString());
            }
        } catch (Exception ex) {
            Logger.getLogger(TwitterProviderServlet.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
