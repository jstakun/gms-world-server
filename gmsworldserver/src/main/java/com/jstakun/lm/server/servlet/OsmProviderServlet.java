 ...
 * @author jstakun
 */
public class OsmProviderServlet extends HttpServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(OsmProviderServlet.class.getName());
    /** 
    ...
    throws ServletException, IOException {
        ...
        try {
            if (HttpUtils.isEmptyAny(request,"latitudeMin","longitudeMin","latitudeMax","longitudeMax")) {
                ...
                String jsonResponse = LayerHelperFactory.getOsmXapiUtils().processRequest(0.0, 0.0, null, -1, 1, limit, stringLimit, amenity, bbox).toString();
