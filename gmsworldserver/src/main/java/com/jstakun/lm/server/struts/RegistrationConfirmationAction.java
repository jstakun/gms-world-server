 ...
 * @author jstakun
 */
public class RegistrationConfirmationAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (!HttpUtils.isEmptyAny(request, "k", "s")) {
            ...
            if (result) {
               ...
               if (user != null) {
                    MailUtils.sendRegistrationNotification(user.getEmail(), user.getLogin(), request.getSession().getServletContext());
               }
            }
