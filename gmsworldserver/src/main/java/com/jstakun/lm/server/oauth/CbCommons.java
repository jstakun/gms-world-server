...
public class CbCommons {
	...
	private static final String AUTHORIZE_URL = "https://www.coinbase.com/oauth/authorize?response_type=code&client_id=%s&redirect_uri=%s&scope=%s";
	...
	protected static String getAuthorizationUrl() { //TODO add state variable
    	return String.format(AUTHORIZE_URL, Commons.getProperty(Property.CB_API_KEY), CALLBACK_URI, SCOPE);
    }
