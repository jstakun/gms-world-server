...
<div id="footer-outer" class="clear"><div id="footer-wrap">
        ...
        <div class="col-a">
            ...
            <p>Want more info - go to our <a href="http://www.gms-world.net/contact.jsp">contact page</a></p>
        ...
        <div class="col-a">
            ...
            <div class="footer-list">
                <ul>
                    ...
                    <li><a href="http://www.gms-world.net/about.jsp">About</a></li>
                    <li><a href="http://www.gms-world.net/register.jsp">Register</a></li>
                </ul>
            </div>
...
<div id="footer-bottom">
    ...
    <p class="bottom-left">
        &copy; 2010-13 <strong>GMS World</strong>&nbsp; &nbsp; &nbsp;
